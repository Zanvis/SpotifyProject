...
//   selector: 'app-room',
//   standalone: true,
//   imports: [CommonModule, FormsModule, MusicPlayerComponent],
...
//     if (!this.currentUser) {
//       this.error = 'Please log in to join a room';
//       this.router.navigate(['/login']);
//       return;
//     }
...
//       this.error = 'Failed to join room. Redirecting to home...';
...
//       this.error = 'Failed to copy room ID. Please try manually copying it.';
//     }
//   }
...
export class RoomComponent implements OnInit, OnDestroy {
  ...
  onPopState(event: PopStateEvent) {
    ...
    event.preventDefault();
    if (confirm('Are you sure you want to leave the room? You will need to rejoin.')) {
      this.router.navigate(['/']);
    } else {
